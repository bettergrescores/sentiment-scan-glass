...
import { getDatasetContent, getSentimentBreakdown, getSentimentOverTime, getTopProducts, getTopKeywords } from "@/data/mockData";
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const {
        products,
        reviews
      } = getDatasetContent(selectedDataset);
  ...
  return <Layout>
      <DashboardHeader title="Fashion Feedback Dashboard" subtitle="Review insights and sentiment analysis" onRefresh={handleRefresh} />
